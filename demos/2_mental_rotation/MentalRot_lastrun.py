...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.06), jue 23 oct 23:02:39 2014
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/casillas/google_drive/14_fall_2014/proseminar/psychopy2_workshop/demos/2_mental_rotation/MentalRot.psyexp',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif mini_pause_2.status == STARTED and t >= (0.0 + (1.5-win.monitorFramePeriod*0.75)): #most of one frame period left
...
trials = data.TrialHandler(nReps=3, method='random', 
    extraInfo=expInfo, originPath=u'/Users/casillas/google_drive/14_fall_2014/proseminar/psychopy2_workshop/demos/2_mental_rotation/MentalRot.psyexp',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif mini_pause.status == STARTED and t >= (0.0 + (.5-win.monitorFramePeriod*0.75)): #most of one frame period left
