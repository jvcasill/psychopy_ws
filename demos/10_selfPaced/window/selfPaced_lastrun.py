...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/casillas/academia/teaching/workshops/psychopy_ws/demos/10_selfPaced/window/selfPaced.psyexp',
...
for thisTrial in trials:
    ...
    text.setPos([0,0])
    image.setImage('grey.png')
    # keep track of which components have finished
    trialComponents = [ISI, key_resp_2, text, image]
